...
X(1,:) = plot_results('results4.txt', 4, 2, 2, 4);
X(2,:) = plot_results('results8.txt', 8, 2, 2, 1);
X(3,:) = plot_results('results16.txt', 16, 2, 2, 2);
X(4,:) = plot_results('results20.txt', 20, 2, 2, 4);
X(5,:) = plot_results('results24.txt', 24, 2, 2, 3);
X(6,:) = plot_results('results28.txt', 28, 2, 2, 4);
X(7,:) = plot_results('results32.txt', 32, 2, 2, 4);
